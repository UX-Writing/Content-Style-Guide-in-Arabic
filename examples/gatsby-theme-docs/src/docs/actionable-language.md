...
ينبغي أن توفّر الوابط معلومات حول ما يمكن توقعّه بشأن الوجهة أو الإجراءات المرتبطة. وينبغي أن يتمكّن المستخدمين من التنبؤ بما سيحدث بالضغط على رابط ما.
...
- تقديم حل\حلول ليتمكّن المستخدمين من الرجوع وإتمام العملية فورًا.
...
ينبغي **لأزرار اتخاذ الإجراءات** برسائل التأكيد توفير ما يلي:
...
تظهر المواضع المؤقتة في مدخلات (حقول) النماذج قبل إدخال المستخدم لنص. وكقاعدة عامة، ينبغي تجنب المواضع المؤقتة باستثناءالمواقف المحددة أدناه.
...
يمكن استخدام المواضع المؤقتة لطرح سؤال على المستخدم للإجابة عنه حين يكون مطلوبًا منه إكمال حقل ما. ينبغي أن يكون الأسلوب مباشر وبصيغة المخاطب، وينبغي أن تكون الإجابة بسيطة وقصيرة أيضًا.
...
أحيانًا ما يُسهّل المثال على المستخدمين فهم كيفية الإجابة على حقل ما.
